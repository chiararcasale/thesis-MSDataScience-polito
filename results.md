...
| 7 | 143 |
 ...
 - "Male spouse" is the number of responses where the answer was was the male name between ![name1](https://img.shields.io/badge/name1-blue) and ![name2](https://img.shields.io/badge/name2-green) 
 - "Female spouse" is the number of responses where the answer was was the female name between  ![name1](https://img.shields.io/badge/name1-blue) and ![name2](https://img.shields.io/badge/name2-green) 
