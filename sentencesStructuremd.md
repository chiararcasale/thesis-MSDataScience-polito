...
#
### 1 Names
By using only male-female names, the scenarios would be the following (x2 inverting ![name1](https://img.shields.io/badge/name1-blue) and ![name2](https://img.shields.io/badge/name2-green) ):
...
By including neutral names, the scenarios would be the following (x2 inverting ![name1](https://img.shields.io/badge/name1-blue) and ![name2](https://img.shields.io/badge/name2-green) ):
| ![name1](https://img.shields.io/badge/name1-blue) | ![name2](https://img.shields.io/badge/name2-green) | ![name3](https://img.shields.io/badge/name3-yellow) |
|----------|----------|----------|
| Male  | Female   | Male   |
| Male| Female| Female   |
...
### 2 Relationships
The type of relationship should be neutral, so that the LLM can't infere the answer from that. For example: spouse, partner, date, hook-up. Different types of relationships are useful to see if there is a correlation between the type of relationship, and the answer given.
...
With this sentence I'm implying that both Mateo and Isabella have an husband, it could be interesting to see if even in this scenario heterosexuality is assumed to be the norm.
#
### 3 Places
